...
import com.abelmsg.lab13.databinding.ListItemImgBinding
import java.io.File

/**
 * Adaptador para un RecyclerView que muestra imágenes locales almacenadas en archivos.
 *
 * @property fileArray Un array de objetos [File] que representan las imágenes locales a mostrar.
 */
